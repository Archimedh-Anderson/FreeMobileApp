...
def test_normalize_function():
    ...
    try:
        ...
        assert result3['urgence'].iloc[0] in ['ELEVEE', 'HIGH'], f"Reconnaissance colonne alternative échouée: {result3['urgence'].iloc[0]}"
        print(f"  ✅ Test 3: Reconnaissance colonnes alternatives OK (urgence={result3['urgence'].iloc[0]})")
